    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="px-6 py-16 max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold font-mono text-cyan-400 mb-4 flex items-center justify-center">
            <ThiingsIcon name="reaperHood" size={40} className="mr-3" />
            Your Cart
          </h1>
          <p className="text-lg text-gray-400">
            You're not just buying tech — you're investing in legacy tools.
          </p>
          <p className="text-orange-500 font-mono italic mt-2 flex items-center justify-center">
