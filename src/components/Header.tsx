  ...
  return (
    <header className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-conic from-blue-500/5 via-transparent to-cyan-500/5 rounded-full blur-2xl animate-spin" style={{ animationDuration: '20s' }}></div>
      </div>
      ...
      <nav className="relative z-10 flex justify-between items-center p-6 md:p-8">
        <div className="flex items-center space-x-4">
          <img 
            src="/lovable-uploads/59e25f0a-2853-4447-bce5-3f4c193b0af1.png" 
            alt="Reaper Tech Logo" 
