        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button className="bg-cyan-500 hover:bg-cyan-600 text-black font-mono px-6 py-3 rounded-lg">
                ACCESSORIES
              </Button>
              <Button variant="outline" className="border-gray-400 text-gray-300 hover:bg-gray-800 font-mono px-6 py-3 rounded-lg">
                SERVICES
              </Button>
            </div>
          </div>
